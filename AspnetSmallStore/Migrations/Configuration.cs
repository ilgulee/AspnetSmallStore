namespace AspnetSmallStore.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AspnetSmallStore.DAL.StoreContext>
    {
        ...
        protected override void Seed(AspnetSmallStore.DAL.StoreContext context)
        {
